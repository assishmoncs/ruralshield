...
6. Evaluate adversarial and paraphrased examples separately.
...
- Model probabilities are not presented as calibrated confidence unless a calibration layer is added and evaluated.
...
Every trained artifact and scan result records the model version. Retraining must regenerate the committed artifact and evaluation files; CI checks for artifact drift.
